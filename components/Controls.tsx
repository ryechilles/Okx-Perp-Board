...
import { ColumnVisibility, Filters } from '@/lib/types';
...
export function Controls({
  ...
  const visibleCount = Object.values(columns).filter(v => v).length;
              ...
              {[
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => onColumnChange(col.key as keyof ColumnVisibility, e.target.checked)}
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-3">
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <option value=">100">&gt; 100 / N/A</option>
              </select>
            </div>
