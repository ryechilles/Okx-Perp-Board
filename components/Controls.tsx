  ...
  return (
    <>
      ...
      <div className="flex items-center gap-4 mb-4 flex-wrap">
        ...
        {/* Customize button - chip/tag style */}
        <button
          className="flex items-center gap-1.5 px-3 h-8 rounded-md text-[13px] font-medium transition-all bg-[#F6F7F9] text-[#6B7280] hover:bg-gray-200 hover:text-gray-700"
