...
export function RsiOversold({ tickers, rsiData, marketCapData, onTokenClick, exchangeLabel = 'OKX' }: RsiOversoldProps) {
  ...
  return (
    <SmallWidget
      ...
      subtitle={`Avg RSI ≤ ${RSI.OVERSOLD} in ${exchangeLabel} Perp Top ${WIDGET.TOP_TOKENS_COUNT}`}
      loading={isLoading}
      tooltip={
        <TooltipList items={[
